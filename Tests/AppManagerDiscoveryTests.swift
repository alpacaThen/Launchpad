...
final class AppManagerDiscoveryTests: BaseTestCase {
    ...
    func testPageGroupingWithSinglePage() {
        ...
        let apps = (0..<5).map { i in
            AppGridItem.app(AppInfo(name: "App \(i)", icon: mockIcon, path: "/App\(i).app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0))
        }
    ...
    func testPageGroupingWithSparsePageNumbers() {
        ...
        let apps = [
            AppGridItem.app(AppInfo(name: "App 0", icon: mockIcon, path: "/App0.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0)),
            AppGridItem.app(AppInfo(name: "App 1", icon: mockIcon, path: "/App1.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 2)),
            AppGridItem.app(AppInfo(name: "App 2", icon: mockIcon, path: "/App2.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 5)),
        ]
    ...
    func testPageGroupingPreservesAppData() {
        let mockIcon = NSImage(size: NSSize(width: 64, height: 64))
        let originalApp = AppInfo(name: "Test App", icon: mockIcon, path: "/TestApp.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0)
    ...
    func testPageGroupingWithAppsAndFolders() {
        ...
        let app1 = AppInfo(name: "App 1", icon: mockIcon, path: "/App1.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0)
        let app2 = AppInfo(name: "App 2", icon: mockIcon, path: "/App2.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0)
        let folderApp = AppInfo(name: "Folder App", icon: mockIcon, path: "/FolderApp.app", bundleId: "com.test.app", lastOpenedDate: nil, installDate: nil, page: 0)
